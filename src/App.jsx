...
const tools = [
  ...
  { name: "QuerySum", category: "LLM", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/queried.svg", description: "AI tool that ingests data sources and produces succinct, natural‐language summaries.", businessValue: "Turns complex reports and datasets into actionable executive summaries in seconds.", govUseCase: "Enables DWP analysts to summarize large benefit‐claim datasets or policy whitepapers instantly for leadership briefings.", caseStudy: "The Scottish Government piloted QuerySum to condense quarterly performance data, cutting prep time from days to hours.",reference: "https://querysum.ai/case-studies",link: "https://querysum.ai"},
  { name: "AutoTestGen",category: "COD", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/autotestgen.svg", description: "Generates unit and integration tests automatically from your codebase.",businessValue: "Increases test coverage without manual effort, catches regressions early.",govUseCase: "Helps DWP’s engineering teams maintain high test coverage on citizen‐facing web apps, reducing production bugs.",caseStudy: "A government IT department used AutoTestGen to boost test coverage from 45% to 85% in two weeks.",reference: "https://autotestgen.com/government-cases",link: "https://autotestgen.com"},
