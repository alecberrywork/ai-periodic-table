...
const tools = [
  ...
  { name: "WP Drafter",category: "BIZ", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/wordpress.svg",description: "AI plugin for WordPress that drafts and optimizes blog posts and pages.",businessValue: "Speeds up content creation and SEO optimization for marketing teams.",govUseCase: "Allows DWP communications teams to draft and publish news updates or guidance pages on gov.uk sites more quickly.",caseStudy: "A UK local authority used WP Drafter to generate and publish community news posts twice as fast as before.",reference: "https://wpdrafter.ai/case-studies",link: "https://wpdrafter.ai"},
  { name: "Data Mocker",category: "COD", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/datadotai.svg",description: "Creates realistic synthetic datasets for testing and development.",businessValue: "Enables safe, GDPR‑compliant test data generation, accelerating dev cycles.",govUseCase: "Helps DWP teams generate anonymized benefit‐claim data for offline testing without exposing real PII.",caseStudy: "A UK public sector project used Data Mocker to simulate 100,000 claim records, reducing QA bottlenecks by 50%.",reference: "https://datamocker.io/case-studies",link: "https://datamocker.io"},
  { name: "Amazon Q", category: "LLM", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/amazonaws.svg", description: "A generative AI assistant for developers and business users integrated with AWS services.", businessValue: "Helps engineers build, test, and troubleshoot applications quickly using natural language across AWS tooling.", govUseCase: "DWP engineers could use Amazon Q for infrastructure scripting, app debugging, and accelerating AWS development tasks.", caseStudy: "The U.S. Department of Veterans Affairs integrated Amazon Q with internal dev tools to cut provisioning time by 35%.", reference: "https://aws.amazon.com/q/", link: "https://aws.amazon.com/q/" },
  { name: "LLaMA (Meta AI)", category: "LLM", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/meta.svg", description: "Meta’s open‑weight large language model suite for research and enterprise applications.", businessValue: "Provides flexible, cost‑effective LLM hosting and experimentation for businesses and developers.", govUseCase: "DWP could deploy LLaMA models internally for secure document summarisation, chatbots, or data classification tasks.", caseStudy: "France’s Ministry of Economy used LLaMA to power internal semantic search across regulatory documents.", reference: "https://ai.meta.com/llama/", link: "https://ai.meta.com/llama/" },
