...
const tools = [
  ...
  { name: "Tabnine", category: "COD", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/tabnine.svg", description: "AI code completion tool supporting multiple languages.", businessValue: "Speeds up coding and reduces errors.", govUseCase: "Assists DWP engineering teams with intelligent code suggestions, reducing bugs and boosting productivity.", caseStudy: "A European government agency integrated Tabnine to enhance developer collaboration and code quality.", reference: "https://www.tabnine.com/blog/government-technology", link: "https://tabnine.com" },
  { name: "Midjourney", category: "IMG", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/midjourney.svg", description: "AI tool that generates images from textual prompts.", businessValue: "Accelerates creative workflows and marketing content generation.", govUseCase: "Generates visuals for DWP campaigns, from digital inclusion efforts to disability support services outreach.", caseStudy: "A European public health body used Midjourney to create impactful visuals for mental health awareness campaigns.", reference: "https://midjourney.com/blog/public-sector-campaigns", link: "https://www.midjourney.com" },
  ...
  { name: "Perplexity AI", category: "LLM", logo: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/perplexityai.svg", description: "AI-powered search engine that answers questions using real-time web data.", businessValue: "Enhances research and customer-facing knowledge base search.", govUseCase: "Helps DWP staff and citizens surface accurate, up-to-date information quickly and transparently.", caseStudy: "A UK public library system integrated Perplexity AI to improve public access to information.", reference: "https://www.perplexity.ai/case-studies", link: "https://www.perplexity.ai" },
