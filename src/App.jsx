...
const tools = [
  ...
  // BIZ
  {
    ...
    caseStudy:
      "The State of California's health services department used Jasper to create accessible content for diverse audiences, reducing content creation time by 50%.",
    reference: "https://www.jasper.ai/customers/california-health",
  ...
  },
  {
    ...
    caseStudy:
      "A European government research team used Hugging Face to deploy custom NLP models for document classification.",
    reference: "https://huggingface.co/blog/government-use-cases",
  ...
  },
  {
    ...
    caseStudy:
      "DWP piloted Cohere models for intelligent eligibility checking, reducing processing times.",
    reference: "https://cohere.com/case-studies",
  ...
  // UX
  {
    ...
    caseStudy:
      "A UK government digital design team used Figma to accelerate co-creation workshops with stakeholders.",
    reference: "https://figma.com/customers/government",
  ...
  },
  {
    ...
    caseStudy:
      "A UK government analytics team streamlined reporting presentations using Beautiful.ai.",
    reference: "https://www.beautiful.ai/case-studies",
  ...
  // VID
  {
    ...
    caseStudy:
      "A government social service department produced videos explaining new benefit schemes, increasing engagement by 40%.",
    reference:
      "https://runwayml.com/customers/government-video-production",
  ...
  },
  {
    ...
    caseStudy:
      "A UK government communications team improved video accessibility compliance using Descript.",
    reference: "https://www.descript.com/customers",
  ...
  },
  {
    ...
    caseStudy:
      "A government training department used HeyGen avatars to create personalized onboarding videos.",
    reference: "https://heygen.com/case-studies",
  ...
  },
  {
    ...
    caseStudy:
      "A UK local government used Pictory to convert lengthy policy documents into digestible video summaries.",
